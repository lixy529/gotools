...
var gConfig = `{"addr":"127.0.0.1:19100,127.0.0.2:19100","auth":"123456","dbNum":"1","dialTimeout":"5","readTimeout":"1","writeTimeout":"1","poolSize":"100","minIdleConns":"10","maxConnAge":"3600","poolTimeout":"1","idleTimeout":"300","prefix":"le_"}`
...
func TestRedisdCache(t *testing.T) {
	...
	if err != nil {
		...
		t.Errorf("Codis Get failed. %s is not exist.", k1)
		return
	} else if v11 != v1 {
	...
	if err != nil {
		t.Errorf("Codis Get IsExist. err: %s.", err.Error())
		return
	} else if !isExist {
		t.Error("Codis Get failed. Got false, expected true.")
		return
	}

	err = adapter.Del(k1)
	if err != nil {
		t.Errorf("Codis Delete failed. err: %s.", err.Error())
		return
	}
	...
	if err != nil {
		...
		t.Error("Codis Get failed. Got true, expected false.")
		return
	}
	...
	if err != nil {
		...
		t.Errorf("Codis Get failed. Got %s, expected nil.", v11)
		return
	}
	...
	if err != nil {
		...
		t.Errorf("Codis Get failed. Got %d, expected %d.", v22, v2)
		return
	}
...
// TestRedisdHash
func TestRedisdHash(t *testing.T) {
	adapter := &RedisdCache{}
	err := adapter.Init(gConfig)
	if err != nil {
...
// TestRedisdSet test ordered set.
...
// TestRedisdEncode test encode and decode.
...
// TestRedisdBit 测试bit相关函数
func TestRedisdBit(t *testing.T) {
	var err error
	adapter := &RedisdCache{}
	err = adapter.Init(gConfig)
	if err != nil {
