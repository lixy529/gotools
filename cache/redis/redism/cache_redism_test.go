...
var gConfig = `{"mAddr":"127.0.0.1:6379","mDbNum":"1","mAuth":"123456","sAddr":"127.0.0.2:6379","sDbNum":"1","sAuth":"123456","dialTimeout":"5","readTimeout":"1","writeTimeout":"1","poolSize":"100","minIdleConns":"10","maxConnAge":"3600","poolTimeout":"1","idleTimeout":"300","prefix":"le_"}`
...
// TestRedismHash
func TestRedismHash(t *testing.T) {
	adapter := &RedismCache{}
	err := adapter.Init(gConfig)
	if err != nil {
		t.Errorf("Redism Init failed. err: %s.", err.Error())
...
// TestRedismSet test ordered set.
...
// TestRedisEncode test encode and decode.
